...
<body cur="1" style="background-image:url(../images/menu-bg.jpg)">
    ...
    <div class="wrap">
     ...
     <div class="menu-wrap">
        ...
        <thead>
            <tr>
                <th class="tdone" style="text-align:center">序号</th>
        ...
        <%--<div class="page tc clearfix"><a href="#" class="prev">
            <em></em>上一页</a><span>1</span><a href="#">2</a><a href="#">3</a>
            <a href="#">4</a>...<a href="#">23</a><a href="#" class="next">下一页<em></em></a>
        </div>--%>
      </div>
...
<script type="text/javascript">
    ...
    cart.prototype.xuhaosort = function(){
        ...
        var bxhao = document.querySelector('xuhao');
        for(var i=0,len=bxhao.length;i<len;i++){
        	bxhao[i].innerHTML = i+1;
