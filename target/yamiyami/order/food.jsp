        ...
        <div class="wrap clearfix pr">
            ...
            <ul class="nav fr">
                ...
                <li>
                    ...
                    <ul class="slide-nav">
                        <li><a href="${pageContext.request.contextPath}/Menu/western">西餐</a></li>
                        <li><a href="<c:url value="/Menu/drink"/>">饮品</a></li>
                ...
                <c:forEach items="${menuList}" var="menu">
                    <div>
                        <tr class="trclass">
                            ...
                            <td class="tdfour"><span>单价：</span><span class="unit"><c:out
