...
<div class="layui-layout layui-layout-admin" id="layui_layout">
	...
	<div class="layui-header header header-demo">
		<div class="layui-main">
			...
			<div class="admin-logo-box">
				<a class="logo" href="http://www.kuxuebao.net" title="logo">YAMIYAMI用户</a>
	...
	<div class="layui-side layui-side-bg layui-larry-side" id="larry-side">
		...
		<ul class="layui-nav layui-nav-tree">
			<li class="layui-nav-item layui-this">
				<a href="javascript:;" data-url="/CustomerBackstage/c_main.jsp">
			...
			<li class="layui-nav-item">
				...
				<a href="javascript:;" data-url="CustomerBackstage/c_personInfo.jsp">
			...
			<!-- 用户管理 -->
			<li class="layui-nav-item">
				<a href="javascript:;" data-url="CustomerBackstage/c_changepwd.jsp">
                            <i class="iconfont icon-iconfuzhi01" data-icon='icon-iconfuzhi01'></i>
                            <span>修改密码</span>
                        </a>
            </li>
			<!--<li class="layui-nav-item">
				<a href="javascript:;" data-url="c_table.jsp">
			...
			<li class="layui-nav-item">
					...
					<dl class="layui-nav-child">
                           <dd>
                           	   <a href="javascript:;" data-url="/customer/findAllOrders">
								  <%--CustomerBackstage/c_table.jsp--%>
					    		   <i class="iconfont icon-yonghu1" data-icon='icon-yonghu1'></i>
					    		   <span>账单概览</span>
					    		</a>
                           </dd>
                           <dd>
                           	  <a href="javascript:;" data-url="CustomerBackstage/c_information.jsp">
					    		   <i class="iconfont icon-yonghu1" data-icon='icon-yonghu1'></i>
					    		   <span>账单详情</span>
					    		</a>
                           </dd>
			...
			<!--<li class="layui-nav-item">
				...
				<!--<li class="layui-nav-item">
					...
					<dl class="layui-nav-child">
                           <dd>
                           	   <a href="javascript:;" data-url="c_404.jsp">
					              <i class="iconfont icon-zhuti"  data-icon='icon-zhuti'></i>
					              <span>404提示页面</span>
					           </a>
                           </dd>
                           <dd>
                           	   <a href="javascript:;" data-url="c_tab.jsp">
					              <i class="iconfont icon-zhuti"  data-icon='icon-zhuti'></i>
					              <span>选项卡页面</span>
					           </a>
                           </dd>
		...
		<div class="layui-tab layui-tab-card larry-tab-box" id="larry-tab" lay-filter="demo" lay-allowclose="true">
			...
			<div class="layui-tab-content" style="min-height: 150px; ">
				<div class="layui-tab-item layui-show">
					<iframe class="larry-iframe" data-id='0' src="../CustomerBackstage/c_main.jsp"></iframe>
				</div>
			</div>
		</div>
	</div>
...
<div class="lock-screen" style="display: none;">
	<div id="locker" class="lock-wrapper">
		...
		<div class="lock-box center">
			<img src="../c_images/userimg.jpg" alt="">
			<h1>admin</h1>
